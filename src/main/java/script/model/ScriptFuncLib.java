...
public abstract class ScriptFuncLib {
    ...
    public static void initialize() {
        ...
        putFuncWithIdx(0x0010, new ScriptFunc("getEntranceIndex", "int", null));
        ...
        putFuncWithIdx(0x0066, new ScriptFunc(p("boxIndex", "int"), p(2)));
        ...
        putFuncWithIdx(0x009D, new ScriptFunc(p("boxIndex", "int"), p(2)));
        ...
        putFuncWithIdx(0x00EC, new ScriptFunc("findPartyMemberFormationIndex", "int", null, p("playerChar"))); // get actor's battle formation index, or -1 if not present?
        putFuncWithIdx(0x00ED, new ScriptFunc("getWorkerLinkedActor", "btlActor", null, true)); // get ID of attached actor
        ...
        putFuncWithIdx(0x0141, new ScriptFunc("?setBoxToConstructedString", "unknown", null, p("boxIndex", "int"), p("constructedString", "unknown"), p(3)));
        ...
        putFuncWithIdx(0x01F2, new ScriptFunc("getActiveSummonsBitfield", "bitfield", null, true));
        ...
        putFuncWithIdx(0x5000, new ScriptFunc(p("motion"))); // Why was this 0?
        ...
        putFuncWithIdx(0x700F, new ScriptFuncAccessor("readBattleActorProperty", "btlActor", "btlGetStat", null, "btlActorProperty"));
        putFuncWithIdx(0x7010, new ScriptFunc("findMatchingChr", "btlActor", "btlSearchChr", p("group", "btlActor"), p("property", "btlActorProperty"), p("unused", "unknown"), p("selector")));
        ...
        putFuncWithIdx(0x7018, new ScriptFuncAccessor("writeBattleActorProperty", "btlActor", "btlSetStat", "=", "btlActorProperty"));
        ...
        putFuncWithIdx(0x701B, new ScriptFunc("overrideAttemptedAction", "unknown", "btlChangeReCom", p("target", "btlActor"), p("move")));
        putUnknownFunc(0x701C, "btlSetMotionLevel", 1);
        putUnknownFunc(0x701D, "btlGetMotionLevel", 0);
        putFuncWithIdx(0x701E, new ScriptFunc("countActorsIn", "int", "btlCountChr", p("within", "btlActor"), p("btlActor")));
        ...
        putFuncWithIdx(0x7025, new ScriptFunc("findMatchingChrIncludingUntargetable?", "btlActor", "btlSearchChr2", p("group", "btlActor"), p("property", "btlActorProperty"), p("unknown"), p("selector")));
        ...
        putFuncWithIdx(0x7032, new ScriptFuncAccessor("setActorFacingAngle", "btlActor", "btlSetBtlPosDir", "=", p("facingAngle", "float")));
        ...
        putFuncWithIdx(0x7037, new ScriptFunc("addMove", "unknown", "btlAddCom", p("btlActor"), p("move")));
        putFuncWithIdx(0x7038, new ScriptFunc("removeMove", "unknown", "btlDelCom", p("btlActor"), p("move")));
        putUnknownFunc(0x7039, "btlTerminateDeath", 0);
        putUnknownFunc(0x703A, "btlSetSpeed", 1);
        putFuncWithIdx(0x703B, new ScriptFunc("setMoveDisabled", "unknown", "btlSetCommandUse", p("btlActor"), p("move"), p("disabled", "bool")));
        ...
        putFuncWithIdx(0x704A, new ScriptFunc(null, "unknown", "btlCheckMove", p("btlActor")));
        putFuncWithIdx(0x704B, new ScriptFunc(null, "unknown", "btlReqMotion", p("btlActor"), p("motionIndex", "int"), p("?await", "bool")));
        putFuncWithIdx(0x704C, new ScriptFunc(null, "unknown", "btlWaitReqMotion", p("btlActor")));
        ...
        putFuncWithIdx(0x7050, new ScriptFunc("revive/reinitialize", "unknown", "btlResetParam", p("btlActor")));
        putUnknownFunc(0x7051, "btlWaitNormalEffect", 0);
        putFuncWithIdx(0x7052, new ScriptFunc("attachActor", "unknown", "btlChrLink", p( "btlActor"), p( "host","btlActor"), p( "attachmentPoint","int")));
        putUnknownFunc(0x7053, "btlMoveJump", 9);
        putFuncWithIdx(0x7054, new ScriptFunc(null, "unknown", "btlSetChrPosElem", p("btlActor"), p(2), p(3)));
        putUnknownFunc(0x7055, "btlSetBodyHit", 1);
        putUnknownFunc(0x7056, "btlSetSpecialBattle", 1);
        putUnknownFunc(0x7057, "btlDirMove", 4);
        putFuncWithIdx(0x7058, new ScriptFunc(null, "unknown", "btlCheckMotionNum", p("btlActor"), p("stdmotion")));
        putUnknownFunc(0x7059, "btlMoveTargetDist2D", "float", 1);
        putFuncWithIdx(0x705A, new ScriptFunc("forcePerformMove", "bool", "btlSetAbsCommand", p("target", "btlActor"), p("move")));
        ...
        putFuncWithIdx(0x706D, new ScriptFunc(null, "unknown", "btlSoundStreamNormal", p("btlActor"), p(2)));
        putFuncWithIdx(0x706E, new ScriptFunc(null, "unknown", "btlReqVoice", p("btlActor"), p(2)));
        ...
        putFuncWithIdx(0x7075, new ScriptFunc(null, "unknown", "btlReqWeaponMotion", p("btlActor"), p(2), p(3)));
        putUnknownFunc(0x7076, "btlBallSplineMove", 3);
        putUnknownFunc(0x7077, "btlDistTargetFrameBall", 2);
        putFuncWithIdx(0x7078, new ScriptFuncAccessor("readMovePropertyForActor", "move", "btlGetComInfo2", null, "moveProperty", p("btlActor")));
        putUnknownFunc(0x7079, "btlResetWeapon", 0);
        putFuncWithIdx(0x707A, new ScriptFunc(null, "unknown", "btlGetCalcResult", p("btlActor")));
        putFuncWithIdx(0x707B, new ScriptFunc(null, "unknown", "btlSoundEffect", p("btlActor"), p(2)));
        ...
        putFuncWithIdx(0x707F, new ScriptFunc(null, "unknown", "btlSetBtlPos", p("btlActor")));
        ...
        putFuncWithIdx(0x7087, new ScriptFunc(null, "unknown", "btlSoundEffectFade", p("btlActor"), p(2), p(3)));
        putFuncWithIdx(0x7088, new ScriptFunc(null, "unknown", "btlRegSoundEffect", p("btlActor"), p(2)));
        ...
        putFuncWithIdx(0x7092, new ScriptFunc(null, "unknown", "btlGetGroundDist", p("btlActor")));
        ...
        putFuncWithIdx(0x709E, new ScriptFunc(null, "unknown", "btlSetMotionSignal", p("btlActor"), p(2), p(3)));
        putUnknownFunc(0x709F, "btlGetChrTargetDir", "float", 1);
        putUnknownFunc(0x70A0, "btlSetUpVectorFlag", 1);
        putFuncWithIdx(0x70A1, new ScriptFunc("dereferenceEnemy", "btlActor", "btlGetChrNum2", p("btlActor")));
        ...
        putFuncWithIdx(0x70B6, new ScriptFunc(null, "unknown", "btlDistTargetFrameSpd", p("btlActor")));
        ...
        putFuncWithIdx(0x70C9, new ScriptFunc(null, "unknown", "btlSoundEffect3", p("btlActor"), p(2)));
        putUnknownFunc(0x70CA, "btlRegSoundEffect2", 2);
        putUnknownFunc(0x70CB, "btlRegSoundEffect3", 2);
        putFuncWithIdx(0x70CC, new ScriptFunc("initializeMatchingGroupTo", "unknown", "btlSetOwnTarget", p("btlActor")));
        putFuncWithIdx(0x70CD, new ScriptFunc("addToMatchingGroup", "unknown", "btlAddOwnTarget", p("btlActor")));
        putFuncWithIdx(0x70CE, new ScriptFunc("removeFromMatchingGroup", "unknown", "btlSubOwnTarget", p("btlActor")));
        putUnknownFunc(0x70CF, "btlGetReverbe", 0);
        putUnknownFunc(0x70D0, "btlSetCameraSelectMode", 1);
        putFuncWithIdx(0x70D1, new ScriptFunc(null, "unknown", "btlGetNomEff", p("btlActor")));
        putUnknownFunc(0x70D2, "btlGetHitEff", 1);
        putUnknownFunc(0x70D3, "btlSetNomEff", 3);
        putUnknownFunc(0x70D4, "btlSetHitEff", 3);
        putFuncWithIdx(0x70D5, new ScriptFunc("setSummoner", "unknown", "btlSetSummoner", p("btlActor")));
        putFuncWithIdx(0x70D6, new ScriptFunc("calculateAverageDamage", "int", "btlGetAssumeDamage", p("user", "btlActor"), p("target", "btlActor"), p("move")));
        putFuncWithIdx(0x70D7, new ScriptFunc(null, "unknown", "btlSetDamageMotion", p("btlActor"), p("stdmotion")));
        ...
        putFuncWithIdx(0x70DC, new ScriptFunc("changeActorName", "unknown", "btlChangeChrNameID", p("btlActor"), p("string", "localString")));
        ...
        putFuncWithIdx(0x70E2, new ScriptFunc(null, "unknown", "btlSetTexAnime", p("btlActor"), p(2)));
        ...
        putFuncWithIdx(0x70E6, new ScriptFunc(null, "unknown", "btlSetHitEffReg", p("btlActor"), p(2), p(3)));
        ...
        putFuncWithIdx(0x7106, new ScriptFunc("doesActorKnowMove", "bool", "btlCheckGetCommand", p("btlActor"), p("move")));
        putUnknownFunc(0x7107, "btlDirPosBasic2", 1);
        putUnknownFunc(0x7108, "btlDirBasic2", 2);
        putFuncWithIdx(0x7109, new ScriptFunc(null, "unknown", "btlSetAppear", p("btlActor"), p(2), p(3)));
        ...
        putFuncWithIdx(0x7110, new ScriptFunc("activateMouthMovement", "unknown", "btlMouseOn", p("btlActor")));
        putFuncWithIdx(0x7111, new ScriptFunc("deactivateMouthMovement", "unknown", "btlMouseOff", p("btlActor")));
        ...
        putFuncWithIdx(0x7117, new ScriptFunc("overrideDeathAnimationWithAction", "unknown", "btlSetDeathCommand", p("target", "btlActor"), p("move")));
