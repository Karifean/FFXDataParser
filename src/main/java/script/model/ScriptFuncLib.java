...
public abstract class ScriptFuncLib {
    ...
    private static ScriptFunc putUnknownFunc(int idx, String internalName, int inputs) {
        ...
        ScriptFunc func = new ScriptFunc(null, "unknown", internalName, inputList);
    ...
    public static void initialize() {
        if (FUNCS == null) {
            ...
            putFuncWithIdx(0x004D, new ScriptFunc("controllerButtonPressed?", "bool", null, new ScriptField("button")));
            ...
            putFuncWithIdx(0x0064, new ScriptFunc("displayFieldSubtitle", "unknown", null, new ScriptField("index?", "int"), new ScriptField("string", "int")));
            ...
            putFuncWithIdx(0x00A9, new ScriptFunc("RandomValue", "int", null, false));
            ...
            putFuncWithIdx(0x0102, new ScriptFunc("setBgmToLoad?", "unknown", null, new ScriptField("bgm", "musicfile")));
            putUnknownFunc(0x0103, 1);
            putFuncWithIdx(0x0104, new ScriptFunc("playBgm?", "unknown", null, new ScriptField("bgm", "musicfile")));
            ...
            putFuncWithIdx(0x015B, new ScriptFunc("obtainTreasure", "unknown", null, new ScriptField("index?", "int"), new ScriptField("treasureId", "int")));
            ...
            putUnknownFunc(0x600A, "camMove", 1);
            putUnknownFunc(0x6010, "camMovePolar", 1);
            putUnknownFunc(0x6011, "camMoveCos", 1);
            putUnknownFunc(0x6012, "camMovePolarCos", 1);
            ...
            putFuncWithIdx(0x700E, new ScriptFunc("setDamage?", "unknown", "btlSetDamage", new ScriptField("int")));
            putFuncWithIdx(0x700F, new ScriptFuncAccessor("readActorProperty", "actor", "btlGetStat", null, ScriptConstants.ACTOR_PROPERTIES, "actorProperty"));
            ...
            putFuncWithIdx(0x7018, new ScriptFuncAccessor("writeActorProperty", "actor", "btlSetStat", "=", ScriptConstants.ACTOR_PROPERTIES, "actorProperty"));
            putFuncWithIdx(0x7019, new ScriptFunc("usedMove", "move", "btlGetReCom", false));
            putFuncWithIdx(0x701A, new ScriptFuncAccessor("readMoveProperty", "move", "btlGetComInfo", null, ScriptConstants.MOVE_PROPERTIES, "moveProperty"));
            ...
            putFuncWithIdx(0x7032, new ScriptFuncAccessor("setActorFacingAngle", "actor", "btlResetBtlPosDir", "=", new ScriptField("facingAngle", "int")));
            ...
            putFuncWithIdx(0x703C, new ScriptFunc("runBattleScriptA", "unknown", null, new ScriptField("index", "int")));
            ...
            putFuncWithIdx(0x7064, new ScriptFunc("playBattleVoiceLine", "unknown", "btlVoiceStandby", new ScriptField("voiceFileIndex", "int")));
            ...
            putFuncWithIdx(0x7072, new ScriptFunc("displayDialogueLine", "unknown", "btlmes2", new ScriptField("index?", "int"), new ScriptField("string", "int")));
            putUnknownFunc(0x7073, 1);
            putUnknownFunc(0x7074, 1);
            putUnknownFunc(0x7075, 3);
            putUnknownFunc(0x7076, 3);
            putUnknownFunc(0x7077, 2);
            putFuncWithIdx(0x7078, new ScriptFuncAccessor("readMovePropertyForActor", "move", "btlGetComInfo2", null, ScriptConstants.MOVE_PROPERTIES, "moveProperty", new ScriptField("actor")));
            ...
            putFuncWithIdx(0x7097, new ScriptFunc("runBattleScriptB", "unknown", null, new ScriptField("index", "int")));
            ...
            putFuncWithIdx(0x70AA, new ScriptFuncAccessor("readActorProperty", null, "btlGetStat2", null, ScriptConstants.ACTOR_PROPERTIES, "actorProperty"));
            putFuncWithIdx(0x70AB, new ScriptFuncAccessor("setActorProperty2", null, "btlSetStat2", "=", ScriptConstants.ACTOR_PROPERTIES, "actorProperty"));
            ...
            putFuncWithIdx(0x70CF, new ScriptFunc("voiceLanguage?", "language", null, false));
            ...
            putFuncWithIdx(0x70E9, new ScriptFunc("YojimboHireAnswer", "int", null, false));
            putUnknownFunc(0x70EB, 1); // Could be 0 if EE is 2 but doubtful
            putFuncWithIdx(0x70ED, new ScriptFunc("getItem", "unknown", "btlGetItem", new ScriptField("item", "move"), new ScriptField("quantity", "int")));
            putFuncWithIdx(0x70EE, new ScriptFunc("RollYojimboMove", "move", null, new ScriptField("motivation", "int")));
            ...
            putFuncWithIdx(0x70F3, new ScriptFunc("RollRandomIn256", "bool", null, new ScriptField("unknown"), new ScriptField("chance", "int")));
            ...
            putFuncWithIdx(0x7120, new ScriptFunc("displayBattleSubtitle?", "unknown", null, new ScriptField("index?", "int"), new ScriptField("string", "int")));
