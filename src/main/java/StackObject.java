    ...
    public String toString() {
        if (!expression && !"unknown".equals(type)) {
            ...
            if ("bool".equals(type)) {
                ...
                if (ScriptConstants.ACTOR_NAMES.containsKey(value)) {
                    return ScriptConstants.ACTOR_NAMES.get(value);
                ...
                if (value == 0) {
                    ...
                    return "Switch/Summon:" + ScriptConstants.ACTOR_NAMES.get(value) + hexSuffix;
                } else {
