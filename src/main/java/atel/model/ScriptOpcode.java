...
public class ScriptOpcode extends ScriptField {
    ...
    public static void initialize() {
        ...
        putOpcode(0x36, "Run script asynchronously", "exec", "REQ", p("level", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x37, "Run script and await start", "exec", "REQSW", p("level", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x38, "Run script and await end", "exec", "REQEW", p("level", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x39, "PREQ");
        putOpcode(0x3A, "PREQSW");
        putOpcode(0x3B, "PREQEW");
        ...
        putOpcode(0x4A, "FREQSW");
        putOpcode(0x4B, "TREQSW");
        putOpcode(0x4C, "BREQSW");
        putOpcode(0x4D, "BFREQSW");
        putOpcode(0x4E, "BTREQSW");
        putOpcode(0x4F, "FREQEW");
        putOpcode(0x50, "TREQEW");
        putOpcode(0x51, "BREQEW");
        putOpcode(0x52, "BFREQEW");
        putOpcode(0x53, "BTREQEW");
