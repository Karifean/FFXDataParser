...
public class ScriptOpcode extends ScriptField {
    ...
    public static void initialize() {
        ...
        putOpcode(0x36, "Run script asynchronously", "exec", "REQ", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x37, "Run script and await start", "exec", "REQSW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x38, "Run script and await end", "exec", "REQEW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x39, "Run party member script asynchronously", "unknown", "PREQ", p("priority", "int"), p("index", "int"), p("e", "int"));
        putOpcode(0x3A, "Run party member script and await start", "unknown", "PREQSW", p("priority", "int"), p("index", "int"), p("e", "int"));
        putOpcode(0x3B, "Run party member script and await end", "unknown", "PREQEW", p("priority", "int"), p("index", "int"), p("e", "int"));
        ...
        putOpcode(0x45, "Run script (forcibly) asynchronously", "exec", "FREQ", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x46, "Run script (if not queued/running) asynchronously", "exec", "TREQ", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x47, "Run script (conditionally) asynchronously", "exec", "BREQ", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x48, "Run script (conditionally, forcibly) asynchronously", "exec", "BFREQ", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x49, "Run script (conditionally, if not queued/running) asynchronously", "exec", "BTREQ", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x4A, "Run script (forcibly) and await start", "exec", "FREQSW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x4B, "Run script (if not queued/running) and await start", "exec", "TREQSW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x4C, "Run script (conditionally) and await start", "exec", "BREQSW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x4D, "Run script (conditionally, forcibly) and await start", "exec", "BFREQSW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x4E, "Run script (conditionally, if not queued/running) and await start", "exec", "BTREQSW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x4F, "Run script (forcibly) and await end", "exec", "FREQEW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x50, "Run script (if not queued/running) and await end", "exec", "TREQEW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x51, "Run script (conditionally) and await end", "exec", "BREQEW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x52, "Run script (conditionally, forcibly) and await end", "exec", "BFREQEW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        putOpcode(0x53, "Run script (conditionally, if not queued/running) and await end", "exec", "BTREQEW", p("priority", "int"), p("w", "worker"), p("e", "int"));
        ...
        putOpcode(0x78, "await party member script", "void", "PREQWAIT", p("index", "int"), p("e", "int"));
    ...
    public static MenuButton getOpcodeChoices(OpcodeChoiceAction action, String type) {
        ...
        if (type.equals("exec")) {
            ...
            runningRootChoices.add(opcodeChoice(0x36, "Run wXXeYY asynchronously", action));
            runningRootChoices.add(opcodeChoice(0x37, "Run wXXeYY and await start", action));
            runningRootChoices.add(opcodeChoice(0x38, "Run wXXeYY and await end", action));
            return runningRoot;
        }
