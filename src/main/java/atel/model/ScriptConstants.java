...
public class ScriptConstants {
    ...
    public void initialize() {
        ...
        putSaveDataVariable(0xC7C, "JechtSpheresFoundFlags", "int");
        ...
        putEnum("bgm", 0x0A, "Unwavering Determination");
        putEnum("bgm", 0x0B, "Secret Maneuvers");
        putEnum("bgm", 0x0C, "Boss Theme");
        putEnum("bgm", 0x0D, "The Summoning");
        putEnum("bgm", 0x0E, "Macalania Woods");
        putEnum("bgm", 0x0F, "Wandering Flame");
        putEnum("bgm", 0x10, "Battle Theme");
        putEnum("bgm", 0x11, "Phantoms (Lake Macalania Theme?)");
        putEnum("bgm", 0x12, "Out of the Frying Pan");
        putEnum("bgm", 0x13, "Mi'ihen Highroad");
        putEnum("bgm", 0x14, "Ride ze Shoopuf");
        putEnum("bgm", 0x15, "Brave Advancement (Monster Arena Theme)");
        putEnum("bgm", 0x16, "Spira Unplugged");
        putEnum("bgm", 0x17, "The Trials");
        putEnum("bgm", 0x18, "The Blitzers");
        putEnum("bgm", 0x19, "The Unsent Laugh (Garden of Pain)");
        putEnum("bgm", 0x1A, "Seymour's Ambition");
        putEnum("bgm", 0x1B, "Blitz Off!");
        putEnum("bgm", 0x1C, "Crisis");
        putEnum("bgm", 0x1D, "Thunder Plains");
        putEnum("bgm", 0x1E, "Rikku's Theme");
        putEnum("bgm", 0x1F, "Underwater Ruins");
        putEnum("bgm", 0x20, "Braska's Daughter");
        putEnum("bgm", 0x22, "Seymour's Theme");
        putEnum("bgm", 0x23, "Face Off (Luca Goers Theme)");
        putEnum("bgm", 0x24, "Guadosalam");
        putEnum("bgm", 0x25, "Servants of the Mountain (Mt Gagazet Theme)");
        putEnum("bgm", 0x26, "Brass de Chocobo");
        putEnum("bgm", 0x27, "Besaid");
        putEnum("bgm", 0x28, "Scorching Desert (Bikanel Theme)");
        putEnum("bgm", 0x29, "Truth Revealed");
        putEnum("bgm", 0x2A, "Seymour Battle");
        putEnum("bgm", 0x2B, "Pursuit");
        putEnum("bgm", 0x2C, "?Eerie");
        putEnum("bgm", 0x2E, "Wakka's Theme");
        putEnum("bgm", 0x30, "Prelude");
        putEnum("bgm", 0x31, "Otherworld (BFA)");
        putEnum("bgm", 0x32, "Decisive Battle");
        putEnum("bgm", 0x33, "Jecht's Theme");
        putEnum("bgm", 0x80, "Movement in Green");
        putEnum("bgm", 0x81, "The Splendid Performance");
        putEnum("bgm", 0x82, "To Zanarkand");
        putEnum("bgm", 0x83, "Launch");
        putEnum("bgm", 0x84, "Djose Temple");
        putEnum("bgm", 0x85, "Rin's Travel Agency");
        putEnum("bgm", 0x86, "Yuna's Decision");
        putEnum("bgm", 0x87, "Path of Repentance");
        putEnum("bgm", 0x88, "Yuna's Theme");
        putEnum("bgm", 0x89, "Patricide");
        putEnum("bgm", 0x8A, "Victory Fanfare");
        putEnum("bgm", 0x8B, "Calm before the Storm");
        putEnum("bgm", 0x8C, "Game Over");
        putEnum("bgm", 0x8D, "A Fleeting Dream");
        putEnum("bgm", 0x8E, "Illusion (Unused / Lake Macalania Theme again?)");
        putEnum("bgm", 0x8F, "Good Night");
        putEnum("bgm", 0x90, "Nostalgia (Unused)");
        putEnum("bgm", 0x91, "Challenge");
        putEnum("bgm", 0x92, "Auron's Theme");
        putEnum("bgm", 0x93, "Luca");
        putEnum("bgm", 0x94, "Hum of the Fayth (Tidus)");
        putEnum("bgm", 0x95, "Hymn of the Fayth (Generic)");
        putEnum("bgm", 0x97, "Hymn of the Fayth (Anima)");
        putEnum("bgm", 0x98, "Hymn of the Fayth (Ixion)");
        putEnum("bgm", 0x99, "Hymn of the Fayth (Yojimbo)");
        putEnum("bgm", 0x9A, "Hymn of the Fayth (Ifrit)");
        putEnum("bgm", 0x9B, "Hymn of the Fayth (Shiva)");
        putEnum("bgm", 0x9C, "Hymn of the Fayth (Valefor)");
        putEnum("bgm", 0xA1, "Tidus' Theme");
        putEnum("bgm", 0xA2, "Beyond the Darkness");
        putEnum("bgm", 0xA3, "Oui Are Al Bhed");
        putEnum("bgm", 0xA4, "Grand Maester Mika");
        putEnum("bgm", 0xA5, "Run!!");
        putEnum("bgm", 0xA6, "Assault");
        putEnum("bgm", 0xA7, "The Wedding");
        putEnum("bgm", 0xA8, "Tragedy");
        putEnum("bgm", 0xA9, "Believe (I can fly)");
        putEnum("bgm", 0xAA, "The Void");
        putEnum("bgm", 0xAB, "Lulu's Theme");
        putEnum("bgm", 0xAC, "Gloom");
        putEnum("bgm", 0xAE, "Time of Judgment");
        putEnum("bgm", 0xB0, "A Contest of Aeons");
        putEnum("bgm", 0xB1, "Temple Band (Macalania Temple Arrival)");
        putEnum("bgm", 0xB4, "Hum of the Fayth (Yuna)");
